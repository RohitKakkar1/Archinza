...
import RightPanelDesktop from "./Nophotos/RightPanelDesktop";
import AboutDesktop from "./Nophotos/AboutDesktop";
import AboutMobile from "./Nophotos/AboutMobile";
import RightPanelMobile from "./Nophotos/DBmobile";
import { useState } from "react";
import Header from "./Header";
import DBMobile from "./Nophotos/DBmobile";
import BusinessFooter from "./BusinessFooter";
import BusinessTile from "./Nophotos/BusinessTile";
