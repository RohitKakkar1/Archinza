...
const BusinessPricing = () => {
  return (
    <section className="flex justify-center font-sans items-center bg-blue-100 dark:bg-gray-900 py-10 px-4">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-md flex flex-col lg:flex-row items-center lg:items-start max-w-6xl w-full p-6 lg:p-12">
