    ...
    <section className="flex-1  px-4 sm:px-6 lg:px-8 py-8 lg:py-32">
      <div className="max-w-7xl mx-auto grid items-center gap-8 lg:gap-12 lg:grid-cols-[40%_60%]">
        ...
        <div className="w-full space-y-6">
          ...
          <p className='font-sans'>Think of something you’re curious about, like a product or material, and see what you discover. The best part? Finding everything from the Design & Build world is easy with Archinza Web and WhatsApp.</p>
          <div className="pt-2">
