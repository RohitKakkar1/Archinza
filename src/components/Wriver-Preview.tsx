...
import RightPanelDesktop from "./Wriver-Preview/RightPanelDesktop";
import AboutDesktop from "./Wriver-Preview/AboutDesktop";
import AboutMobile from "./Wriver-Preview/AboutMobile";
import RightPanelMobile from "./Wriver-Preview/DBmobile";
import { useState } from "react";
import Header from "./Header";
import DBMobile from "./Wriver-Preview/DBmobile";
import BusinessFooter from "./BusinessFooter";
import BusinessTile from "./Wriver-Preview/BusinessTile";

const Wriver_Preview = () => {
