...
export default function BusinessCarousel() {
  ...
  return (
    <div className="flex flex-col w-full px-4 gap-4 py-4">
      <div className="flex flex-col gap-0">
        <h2 className="font-medium dark:text-white">Businesses on Archinza</h2>
        <p className="text-sm font-regular dark:text-white">* Upgrade plan to remove this section</p>
      </div>
